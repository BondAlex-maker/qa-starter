var guidely = (function () {
    return {
        ...
        welcome: function () {
            ...
            that = this;
            that.close();
            content = $("<div>", { id: "guide-welcome", class: "guidely-guide" }).appendTo("body");
            ...
            content.css({ position: "absolute", top: "75px", left: "50%", "margin-left": "-" + content.outerWidth() / 2 + "px" });
            close = $("<a>", {
                href: "javascript:;",
        ...
        showOverlay: function () {
            ...
            if (!overlay.length) {
                $("<div>", { class: "guidely-overlay" }).appendTo("body");
            } else {
                overlay.show();
            }
        },
        ...
        _setGuidePosition: function (number, content) {
            ...
            content.css({ position: "absolute", top: offset.top + 15, left: left });
        },
        ...
        _getCoords: function (options) {
            ...
            return { width: el.outerWidth(), height: el.outerHeight(), top: el.offset().top, left: el.offset().left };
        },
